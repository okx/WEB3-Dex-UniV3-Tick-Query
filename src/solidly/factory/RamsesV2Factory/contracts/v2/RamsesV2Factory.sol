...
contract RamsesV2Factory is IRamsesV2Factory, RamsesV2PoolDeployer, Initializable {
    ...
    function createPool(address tokenA, address tokenB, uint24 fee) external override returns (address pool) {
        ...
        pool = _deploy(address(this), nfpManager, veRam, voter, token0, token1, fee, tickSpacing);
    ...
    function setFeeProtocol(uint8 _feeProtocol) external override {
        ...
        emit SetFeeProtocol(feeProtocolOld % 16, feeProtocolOld >> 4, feeProtocol, feeProtocol);
    }

    /// @inheritdoc IRamsesV2Factory
    function setPoolFeeProtocol(address pool, uint8 feeProtocol0, uint8 feeProtocol1) external override {
        require(msg.sender == owner, "AUTH");
        ...
        emit SetPoolFeeProtocol(pool, feeProtocolOld % 16, feeProtocolOld >> 4, feeProtocol0, feeProtocol1);
