...
contract CrocShell {
    ...
    function protocolCmd(uint16 callpath, bytes calldata cmd, bool sudo) public payable {}
    ...
    function userCmdRouter(uint16 callpath, bytes calldata cmd, address client, uint256 salt)
        public
        payable
